...
public class NVPAPICaller
{
    ...
    public string APIUsername = "<rebmid-facilitator_api1.gmail.com>";
    private string APIPassword = "<LMHZBZDT526J78DJ>";
    private string APISignature = "<AFcWxV21C7fd0v3bYYYRCpSSRl31A9KUOpEVgjNxXSjlCup3EMshEur2>";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (Store.Logic.ShoppingCartActions myCartOrders = new Store.Logic.ShoppingCartActions())
        {
